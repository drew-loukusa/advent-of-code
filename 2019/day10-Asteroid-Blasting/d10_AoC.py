...
fpath = (
    r"C:\Users\Drew\Desktop\Code Projects\advent_of_code_2019\day10-Asteroid-Blasting"
)
...
def part_2(path, best_rock, visible_asteroids):
    ...
    while vaporized_count < len(all_the_rocks):
        ...
        if visible_asteroids.count(None) == len(visible_asteroids):
            break
